#!/usr/bin/env -S nix-build -o docker-image-ekklesia-voting.tar
# Run this file: ./docker.nix
# It creates a docker image archive called docker-image-ekklesia-voting.tar.
# Default tag is the git version. You can set a custom tag with:
# ./docker.nix --argstr tag mytag
# Import into docker with:
# docker load -i docker-image-ekklesia-voting.tar
