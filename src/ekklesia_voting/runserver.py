...
parser.add_argument("-b", "--bind", default="localhost", help="hostname / IP to bind to, default ekklesia-voting-localhost")
...
def stackdump_setup():
    ...
    if ultratb is None:
        ...
        logg.info("IPython installed, write stack dumps to tmpdir with: `kill -QUIT <ekklesia_voting_pid>`")

        def dumpstacks(signal, frame):
            print("dumping stack")
            filepath = os.path.join(tmpdir, "ekklesia_voting_threadstatus")
