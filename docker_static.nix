#!/usr/bin/env -S nix-build -o docker-image-ekklesia-voting-static.tar
...
# It creates a docker image archive called docker-image-ekklesia-voting-static.tar.
# Import into docker with:
# docker load -i docker-image-ekklesia-voting-static.tar
